...
outfile = open('bin/zfiles/dict_relations','wb')
pickle.dump(dict_relations, outfile)
outfile.close()

outfile = open('bin/zfiles/dict_publication','wb')
pickle.dump(dict_publication, outfile)
outfile.close()

outfile = open('bin/zfiles/dict_cite','wb')
pickle.dump(dict_cite, outfile)
outfile.close()

outfile = open('bin/zfiles/dict_keyword','wb')
pickle.dump(dict_keyword, outfile)
outfile.close()

outfile = open('bin/zfiles/dict_domain','wb')
pickle.dump(dict_domain, outfile)
outfile.close()

outfile = open('bin/zfiles/dict_author','wb')
pickle.dump(dict_author, outfile)
outfile.close()

outfile = open('bin/zfiles/dict_conference','wb')
pickle.dump(dict_conference, outfile)
outfile.close()

outfile = open('bin/zfiles/dict_journal','wb')
pickle.dump(dict_journal, outfile)
outfile.close()

outfile = open('bin/zfiles/dict_organization','wb')
